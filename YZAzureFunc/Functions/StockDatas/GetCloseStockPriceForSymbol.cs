...
namespace YZAzureFunc.Functions.StockDatas
{
    public class GetCloseStockPriceForSymbol
    {
        ...
        public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "stock-price/symbol/{symbol:alpha}/close")] HttpRequestData req, string symbol)
        {
